...
export const zhHans: Record<keyof typeof en, string> = {
  ...
  "Badge_Refined": "美化",
  "Badge_RowLabel": "快捷方式",
  "Calm_Confirm_Body": "将关闭下面这些推送，全部只改你自己的账户，不需要管理员权限，随时可以恢复。",
  "Calm_Confirm_Cancel": "先不",
  "Calm_Confirm_Go": "开始",
  "Calm_Confirm_GuidedNote": "小组件资讯需要你自己关，我们带你去。",
  "Calm_Confirm_List": "这一下会关闭：{0}。",
  "Calm_Confirm_Title": "一键清爽",
  "Calm_Cta": "一键清爽",
  "Calm_Cta_Done": "已清爽",
  "Calm_Cta_Working": "正在收起推送",
  "Calm_FinishSetup": "完成设备设置提醒",
  "Calm_FinishSetup_Desc": "不再提醒你「完成设备设置」",
  "Calm_GoGuided": "带我去关",
  "Calm_Group_Guided": "带你去系统里关的",
  "Calm_Group_Held": "这个 Windows 版本暂时不碰的",
  ...
  "Calm_LockStatus_Desc": "在系统设置里把锁屏状态调整为无",
  "Calm_LockStatus_Route": "我们会打开锁屏设置，调整后回来",
  "Calm_NotifSuggestions": "通知建议",
  "Calm_NotifSuggestions_Desc": "减少 Windows 的使用建议通知",
  "Calm_Restore": "恢复系统推送",
  "Calm_SearchHighlights": "搜索热点",
  "Calm_SearchHighlights_Desc": "减少搜索框里的热点资讯",
  "Calm_SettingsSuggestions": "设置页推荐",
  "Calm_SettingsSuggestions_Desc": "减少设置应用里的推荐内容",
  "Calm_StartRecs": "开始菜单推荐",
  "Calm_StartRecs_Desc": "减少开始菜单里的推广推荐",
  ...
  "Calm_SyncNotif_Desc": "关闭资源管理器里的推广通知",
  ...
  "Calm_Tray": "系统托盘图标",
  "Calm_Tray_Desc": "在系统设置里选择要显示的托盘图标",
  "Calm_Tray_Route": "我们会打开任务栏设置，调整后回来",
  "Calm_Welcome": "欢迎体验提示",
  "Calm_Welcome_Desc": "更新后不再展示欢迎推荐页",
  "Calm_WidgetsButton": "任务栏小组件按钮",
  "Calm_WidgetsButton_Desc": "Windows 保护此项，需要你在系统设置里关闭",
  "Calm_WidgetsButton_Route": "我们会打开「个性化 > 任务栏」，把小组件关掉后回来",
  "Calm_WidgetsFeed": "小组件资讯与角标",
  "Calm_WidgetsFeed_Desc": "Windows 没有提供直接开关，我们带你到小组件面板，把资讯、悬停展开和角标一起关掉",
