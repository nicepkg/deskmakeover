...
export const en: Dict = {
  ...
  hero: {
    eyebrow: "DeskMakeover",
    title: "The desktop studio for Windows.",
  ...
  looks: {
    ...
    styles: [
      { key: "squircle", name: "Squircle", tagline: "continuous corners" },
      { key: "blueprint", name: "Blueprint", tagline: "monochrome ink" },
      { key: "pixel-era", name: "Pixel Era", tagline: "8-bit afternoon" },
      { key: "gleam", name: "Gleam", tagline: "brushed with light" },
      { key: "glaze", name: "Glaze", tagline: "cool porcelain" },
      { key: "die-cut", name: "Die-Cut", tagline: "sticker outlines" },
      { key: "porthole", name: "Porthole", tagline: "clean circles" },
      { key: "scrapbook", name: "Scrapbook", tagline: "pasted by hand" },
      { key: "creekstone", name: "Creekstone", tagline: "river-worn stone" },
    ],
  },
  zones: {
    index: "03",
