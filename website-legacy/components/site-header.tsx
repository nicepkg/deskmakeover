    ...
    <header className="sticky top-0 z-40 border-b border-hairline bg-canvas/85 backdrop-blur-[14px] backdrop-saturate-[1.1]">
      <div className="mx-auto flex h-16 max-w-[1240px] items-center justify-between px-5 md:px-8">
        ...
        <nav aria-label={dict.locale === "zh" ? "主导航" : "Primary"} className="flex items-center gap-1 md:gap-2">
          <a href="#looks" className="hidden rounded-btn px-3 py-2 text-[14.5px] text-text-mid transition-colors hover:text-text-hi md:block">
            {dict.nav.looks}
          </a>
          <a href="#features" className="hidden rounded-btn px-3 py-2 text-[14.5px] text-text-mid transition-colors hover:text-text-hi md:block">
            {dict.nav.features}
          </a>
          <a href="#faq" className="hidden rounded-btn px-3 py-2 text-[14.5px] text-text-mid transition-colors hover:text-text-hi md:block">
            {dict.nav.faq}
          </a>
          <a
            href={GITHUB_URL}
            className="hidden rounded-btn p-2 text-text-mid transition-colors hover:text-text-hi sm:block"
          ...
          <a
            ...
            className="rounded-btn border border-hairline px-3 py-1.5 text-[13px] font-medium text-text-mid transition-colors hover:border-text-dim hover:text-text-hi"
          ...
          <a
            ...
            className="ml-1 rounded-btn bg-coral-deep px-4 py-2 text-[13.5px] font-semibold text-white transition-colors duration-150 hover:bg-coral active:scale-[0.98]"
          >
            {dict.nav.download}
          </a>
        </nav>
