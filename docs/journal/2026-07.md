...
a second drift wave (the ADR-0019 Tauri replatform never fully propagated into specs 05/06,
conventions, README, development) was found + fixed in the 2026-07-14 doc-hygiene pass; see
`docs/reviews/2026-07-14-doc-hygiene.md` (if present) and the ADR status-header corrections.
