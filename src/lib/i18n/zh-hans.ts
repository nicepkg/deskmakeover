...
export const zhHans: Record<keyof typeof en, string> = {
  ...
  "Calm_Group_Guided_Sub": "Windows 没给直接开关，我们打开对应的设置陪你走一遍",
  ...
  "Calm_HeroPromise": "把 Windows 悄悄塞给你的推荐和推送收起来，随时可以恢复。",
  "Calm_ListJoin": "、",
  "Calm_LockStatus": "锁屏推送",
  "Calm_LockStatus_Desc": "锁屏画面上不再显示天气、资讯这类附加卡片",
  "Calm_LockStatus_Route": "我们会打开锁屏设置，把锁屏状态调整为「无」后回来",
  "Calm_NotifSuggestions": "通知建议",
  "Calm_NotifSuggestions_Desc": "不再弹出「试试这个功能」这类使用建议通知",
  "Calm_Restore": "恢复系统推送",
  "Calm_Restore_Working": "正在恢复",
  "Calm_SearchHighlights": "搜索热点",
  "Calm_SearchHighlights_Desc": "点开搜索框后，不再出现今日热点和节日插图",
  "Calm_SettingsSuggestions": "设置页推荐",
  "Calm_SettingsSuggestions_Desc": "设置应用里不再出现「为你推荐」的内容卡片",
  "Calm_SkipReason_Changed": "这次跳过了：系统状态有变化，重新检查后再试",
  "Calm_StartRecs": "开始菜单推荐",
  "Calm_StartRecs_Desc": "开始菜单不再推荐你没装的应用（你自己的常用文件保留）",
  ...
  "Calm_Surface_Explorer": "文件资源管理器",
  "Calm_Surface_Lockscreen": "锁屏",
  "Calm_Surface_Notifications": "通知",
  "Calm_Surface_Search": "搜索",
  "Calm_Surface_Settings": "设置",
  "Calm_Surface_Start": "开始菜单",
  "Calm_Surface_System": "系统提示",
  "Calm_Surface_Taskbar": "任务栏",
  "Calm_Surface_Widgets": "小组件",
  "Calm_SyncNotif": "资源管理器推广通知",
  "Calm_SyncNotif_Collateral": "也会隐藏网盘同步的提示通知",
  "Calm_SyncNotif_Desc": "文件资源管理器里不再弹出 OneDrive、Office 的推广横幅",
  ...
  "Calm_Tray": "系统托盘图标",
  "Calm_Tray_Desc": "任务栏右下角的图标堆，挑出你想显示的，其余收起来",
  "Calm_Tray_Route": "我们会打开任务栏设置，调整后回来",
  "Calm_Welcome": "欢迎体验提示",
  "Calm_Welcome_Desc": "系统更新后，不再全屏弹出「欢迎体验」推荐页",
  "Calm_WidgetsButton": "任务栏小组件按钮",
  "Calm_WidgetsButton_Desc": "任务栏左下角的天气、资讯入口，Windows 保护此项，需要你亲手关",
  "Calm_WidgetsButton_Route": "我们会打开「个性化 > 任务栏」，把小组件关掉后回来",
  "Calm_WidgetsFeed": "小组件资讯与角标",
  "Calm_WidgetsFeed_Desc": "任务栏天气一碰就弹的新闻流，带你去小组件面板把资讯、悬停、角标和公告一起关掉",
  "Calm_WidgetsFeed_Route": "按 Win+W 打开小组件，在右上角设置里关闭资讯、悬停展开、角标和公告，然后回来",
