...
export const ENGINE_ZH: EngineDict = {
  ...
  cut: {
    ...
    body: "这颗「回收站」，连玻璃篓带废纸都是它自带的「底」。引擎认出真正的图案只有那枚回收标志：把底整层打碎剥走，标志原地不动，再配上一块新算出来的底盘。整套判断来自引擎的真实输出，不是人工描的。",
    caption: "碎裂飘散的每一粒方块，都是引擎判定为「底」的真实像素。这份逐像素判定与桌面端完全一致。拖动可以旋转查看。",
    replay: "重播",
    maskNote: "01 认出底 · 02 碎裂剥离 · 03 换上新底盘",
    layers: { bg: "判为底的玻璃篓", art: "真正的图案", final: "换好底盘的成品" },
  },
  rescue: {
    index: "03",
    kicker: "RESCUE",
