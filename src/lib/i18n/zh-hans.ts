...
export const zhHans: Record<keyof typeof en, string> = {
  ...
  "Badge_Refined": "美化",
  "Badge_RowLabel": "快捷方式",
  "Calm_CanQuiet": "可以让 {0} 处安静 · 随时恢复",
  "Calm_Confirm_Body": "只改你自己的账户，不用管理员权限，随时能一键恢复。",
  "Calm_Confirm_Cancel": "先不",
  "Calm_Confirm_Go": "开始",
  "Calm_Confirm_GuidedNote": "「小组件资讯」这类需要你自己动手，关的时候我们带你去。",
  "Calm_Confirm_List": "这次会关掉：{0}。",
  "Calm_Confirm_Title": "一键清爽",
  "Calm_Cta": "一键清爽",
  "Calm_Cta_Awaiting": "已设置，等重启生效",
  "Calm_Cta_Done": "已清爽",
  "Calm_Cta_Working": "正在收起推送",
  "Calm_FinishSetup": "完成设备设置提醒",
  "Calm_FinishSetup_Desc": "登录后不再提示你「完成设备设置」",
  "Calm_FinishSetup_Route": "我们带你到「系统 > 通知」，你把「完成设备设置」提示关掉后回来",
  "Calm_GoGuided": "带我去关",
  "Calm_Group_Guided": "需要你自己关，我们带路",
  "Calm_Group_Guided_Sub": "我们打开对应的系统设置，陪你走一遍亲手关掉",
  ...
  "Calm_Held_Managed": "由你的组织管理，无法更改",
  ...
  "Calm_LockStatus_Route": "我们带你到锁屏设置，你把锁屏状态调整为「无」后回来",
  ...
  "Calm_NotifSuggestions_Route": "我们带你到「系统 > 通知」，你把建议类通知关掉后回来",
  "Calm_Restore": "恢复系统推送",
  "Calm_RestoreOne": "恢复",
  "Calm_Restore_Working": "正在恢复",
  "Calm_SearchHighlights": "搜索热点",
  "Calm_SearchHighlights_Desc": "不再出现今日热点和节日插图",
  "Calm_SearchHighlights_Route": "我们带你到「隐私和安全性 > 搜索权限」，你把「显示搜索热点」关掉后回来",
  "Calm_SettingsSuggestions": "设置页推荐",
  "Calm_SettingsSuggestions_Desc": "不再出现「为你推荐」卡片",
  "Calm_SettingsSuggestions_Route": "我们带你到「隐私和安全性 > 常规」，你把「在设置中显示建议内容」关掉后回来",
  "Calm_SkipReason_Changed": "这次跳过了：系统状态有变化，重新检查后再试",
  "Calm_StartRecs": "开始菜单推荐",
  "Calm_StartRecs_Desc": "不再推荐你没装的应用（你自己的常用文件保留）",
  "Calm_StartRecs_Route": "我们带你到「个性化 > 开始」，你把「显示推荐项」关掉后回来",
  "Calm_State_Awaiting": "已设置，重启后生效",
  "Calm_State_ConfirmedOff": "已确认关闭",
  "Calm_State_External": "你自己改过，未动",
  "Calm_State_NeedsReconfirm": "系统更新后需重新确认",
  "Calm_State_Pending": "正在验证",
  "Calm_State_Quiet": "已安静",
  "Calm_State_Reverted": "没能关上，已还原",
  "Calm_State_UserAttested": "你手动关的",
  "Calm_State_Verified": "已生效",
  "Calm_Summary": "已让 {0} 处安静",
  "Calm_SyncNotif": "资源管理器推广通知",
  "Calm_SyncNotif_Collateral": "也会隐藏网盘同步的提示通知",
  "Calm_SyncNotif_Desc": "不再弹 OneDrive、Office 推广横幅",
  "Calm_TaskView": "任务视图按钮",
  "Calm_TaskView_Desc": "隐藏任务栏上的任务视图按钮（Win+Tab 仍可用）",
  "Calm_TaskView_Route": "我们带你到「个性化 > 任务栏」，你把「任务视图」关掉后回来",
  "Calm_TaskbarSearch": "任务栏搜索框",
  "Calm_TaskbarSearch_Desc": "隐藏任务栏上的搜索框（Win+S 搜索仍可用）",
  "Calm_TaskbarSearch_Route": "我们带你到「个性化 > 任务栏」，你把「搜索」设为隐藏后回来",
  "Calm_ToastJoin": "，",
  "Calm_ToastPart_Awaiting": "{0} 项重启后生效",
  "Calm_ToastPart_Failed": "{0} 项这次没关成",
  ...
  "Calm_Tray_Route": "我们带你到任务栏设置，你自己挑选要显示的图标后回来",
  "Calm_Welcome": "欢迎体验提示",
  "Calm_Welcome_Desc": "更新后不再全屏弹「欢迎体验」",
  "Calm_Welcome_Route": "我们带你到「系统 > 通知」，你把「欢迎体验」关掉后回来",
  "Calm_WidgetsButton": "任务栏小组件按钮",
  "Calm_WidgetsButton_Desc": "左下角天气入口，需你亲手关",
  "Calm_WidgetsButton_Route": "我们带你到「个性化 > 任务栏」，你把小组件关掉后回来",
  "Calm_WidgetsFeed": "小组件资讯与角标",
  "Calm_WidgetsFeed_Desc": "关掉资讯、悬停、角标和公告",
  "Calm_WidgetsFeed_Route": "我们带你到「个性化 > 任务栏」，你把「小组件」关掉；想留着小组件只关资讯角标，按 Win+W 打开面板设置调整",
  ...
  "Mark_Ring": "细描边",
  "Mark_Satin": "缎光角",
  "Material_Brushed": "拉丝金属",
  "Material_Fluted": "棱纹玻璃",
  "Material_Frost": "磨砂玻璃",
  "Material_LiquidGlass": "流体玻璃",
  ...
  "Paper_ApplyScreenSyncing": "预览正在切换屏幕，请稍候再应用",
  ...
  "Paper_Cta_ApplyScreen": "应用到屏幕 {0}",
  "Paper_DynamicChip": "动态",
  "Paper_DynamicImport": "导入静态图",
  "Paper_DynamicReplaceConfirm": "应用后会用静态壁纸替换这块屏的动态壁纸。",
  "Paper_DynamicReplaceCta": "仍然应用",
  "Paper_DynamicWallpaper": "这块屏在用动态或视频壁纸，无法直接改造",
  "Paper_EditingScreen": "正在编辑 · 屏幕 {0}",
  "Paper_Landscape": "横屏",
  "Paper_Portrait": "竖屏",
  "Paper_ScreenPrimary": "主屏",
  "Paper_SelectScreen": "切换到屏幕 {0}",
  "Paper_SlideshowWarn": "这块屏是 Windows 幻灯片壁纸，应用后轮播会停止。",
  "Paper_SpanNote": "跨屏壁纸 · 所有屏幕共用一张，无法单独设计。",
  ...
  "TitleStyle_Etched": "冰签",
  "TitleStyle_None": "隐藏标题",
  ...
  "Toast_ApplyNoEffect": "没有图标被美化 · 它们可能已在别处改动，请刷新后重试",
  "Toast_ApplySkipped": "已美化 · 跳过 {0} 项（它们已在别处改动，刷新后可重试）",
  ...
  "Zone_MenuDelete": "删除分区",
  "Zone_MenuDuplicate": "复制分区",
  "Zone_MenuHideTitle": "隐藏标题",
  "Zone_MenuRename": "重命名",
  "Zone_MenuShowTitle": "显示标题",
  "Zone_CopySuffix": "副本",
