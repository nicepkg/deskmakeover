...
export const zhHans: Record<keyof typeof en, string> = {
  ...
  "Calm_Toast_Applied": "已让 {0} 处安静",
  "Calm_Toast_AppliedAwaiting": "已让 {0} 处安静，{1} 项重启后生效",
  "Calm_Toast_NothingToDo": "没有需要关的了",
  "Calm_Toast_Partial": "已让 {0} 处安静，{1} 项没能关上（已还原）",
  ...
  "Calm_WidgetsFeed": "小组件资讯",
  "Calm_WidgetsFeed_Desc": "Windows 没有提供直接开关，我们带你到小组件面板里关掉资讯",
  "Calm_WidgetsFeed_Route": "按 Win+W 打开小组件，在右上角设置里关闭资讯推送，然后回来",
